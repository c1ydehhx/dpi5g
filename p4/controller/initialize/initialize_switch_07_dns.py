...
def init(switch: SwitchController, port_infos: List[PortInfo], recirculation_ports: List[PortInfo]):
    switch.add_table_record(
        table_name="forward_specific_ue_udp_dst_port_packet_table", 
        key_names=["hdr.ipv4.srcAddr", "hdr.ipv4.dstAddr", "hdr.ue_udp.dstPort"], 
        key_vals=[ip_to_hex("10.10.216.1"), ip_to_hex("10.10.216.2"), 53], 
